              ...
              <div className="col-md-3 col-lg-3">
                <div className="item">
                  ...
                  <div className="service-body">
                    ...
                    <div className="service-content">
                      <p>
                        Right now your code is wrong because you’re calling
                        dispatch(removeItem(id)) immediately, instead of waiting
                ...
                <div className="card shadow border-0">
                  <div className="card-body p-5">
                    ...
                    <div className="content py-4 pb-2">
                      ...
                      Eligendi rerum libero adipisci saepe et illo dolore
                      cupiditate, odio ab commodi labore nulla doloribus
                      accusamus minima beatae sequi maxime fugit corrupti cumque
                      fugiat deserunt?
                    </div>
                    <hr />
